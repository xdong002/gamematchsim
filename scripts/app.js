    ...
    function tick() {
        ...
        if( seconds > 0 ) {
          ...
          if (ball == 0) {
            ...
            $('.stats1').html('');
            $('.stats1').prepend('<h3>'+ myTeamStats5[0] + ' : <span class = "statlist"> '+ myTeamStats5[1] +'Pts '+ myTeamStats5[2] +'/'+ myTeamStats5[3] +' Feild goal maked '+'</h3>');
            $('.stats1').prepend('<h3>'+ myTeamStats4[0] + ' : <span class = "statlist"> '+ myTeamStats4[1] +'Pts '+ myTeamStats4[2] +'/'+ myTeamStats4[3] +' Feild goal maked '+'</h3>');
            $('.stats1').prepend('<h3>'+ myTeamStats3[0] + ' : <span class = "statlist"> '+ myTeamStats3[1] +'Pts '+ myTeamStats3[2] +'/'+ myTeamStats3[3] +' Feild goal maked '+'</h3>');
            $('.stats1').prepend('<h3>'+ myTeamStats2[0] + ' : <span class = "statlist"> '+ myTeamStats2[1] +'Pts '+ myTeamStats2[2] +'/'+ myTeamStats2[3] +' Feild goal maked '+'</h3>');
            $('.stats1').prepend('<h3>'+ myTeamStats1[0] + ' : <span class = "statlist"> '+ myTeamStats1[1] +'Pts '+ myTeamStats1[2] +'/'+ myTeamStats1[3] +' Feild goal maked '+'</h3>');
...
4
            ...
            $('.stats2').html('');
            $('.stats2').prepend('<h3>'+ oppoTeamStats1[0] + ' : <span class = "oppostatlist"> '+ oppoTeamStats1[1] +'Pts '+ oppoTeamStats1[2] +'/'+ oppoTeamStats1[3] +' Feild goal maked '+'</h3>');
            $('.stats2').prepend('<h3>'+ oppoTeamStats2[0] + ' : <span class = "oppostatlist"> '+ oppoTeamStats2[1] +'Pts '+ oppoTeamStats2[2] +'/'+ oppoTeamStats2[3] +' Feild goal maked '+'</h3>');
            $('.stats2').prepend('<h3>'+ oppoTeamStats3[0] + ' : <span class = "oppostatlist"> '+ oppoTeamStats3[1] +'Pts '+ oppoTeamStats3[2] +'/'+ oppoTeamStats3[3] +' Feild goal maked '+'</h3>');
            $('.stats2').prepend('<h3>'+ oppoTeamStats4[0] + ' : <span class = "oppostatlist"> '+ oppoTeamStats4[1] +'Pts '+ oppoTeamStats4[2] +'/'+ oppoTeamStats4[3] +' Feild goal maked '+'</h3>');
            $('.stats2').prepend('<h3>'+ oppoTeamStats5[0] + ' : <span class = "oppostatlist"> '+ oppoTeamStats5[1] +'Pts '+ oppoTeamStats5[2] +'/'+ oppoTeamStats5[3] +' Feild goal maked '+'</h3>');
            $('.score').prepend("<span class = 'boxScore'>"+myScore+'</span>' + ' : ' + "<span class = 'boxScore'>"+oppoScore+'</span>');
            ball =0;
          }
        }
